...
use App\Api\V1\Http\Requests\Product\ProductReviewRequest;
use App\Api\V1\Http\Resources\Product\{ProductReviewResource, ShowProductReviewResource};
...
class ProductReviewController extends Controller
{
    public function __construct(
        ProductReviewRepositoryInterface $repository
    )
    {
    ...
    public function index(ProductReviewRequest $request){
        ...
        return response()->json([
            ...
            'data' => new ProductReviewResource($reviews)
        ], 200);
    }
    ...
    public function store(ProductReviewRequest $request){
        ...
        return response()->json([
            'status' => 200,
            'message' => __('notifySuccess'),
            'data' => new ShowProductReviewResource($response)
        ], 200);
    }
}